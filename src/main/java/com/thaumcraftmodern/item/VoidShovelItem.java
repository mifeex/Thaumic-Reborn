...
public final class VoidShovelItem extends ShovelItem implements ThaumcraftRepairable {
    public VoidShovelItem(Properties properties) { super(VoidTier.INSTANCE, 1.5F, -3.0F, properties); }
