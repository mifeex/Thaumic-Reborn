...
public final class VoidHoeItem extends HoeItem implements ThaumcraftRepairable {
    public VoidHoeItem(Properties properties) { super(VoidTier.INSTANCE, -3, 0.0F, properties); }
