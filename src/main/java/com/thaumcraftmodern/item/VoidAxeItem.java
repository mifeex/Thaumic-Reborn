...
public final class VoidAxeItem extends AxeItem implements ThaumcraftRepairable {
    public VoidAxeItem(Properties properties) { super(VoidTier.INSTANCE, 5.0F, -3.0F, properties); }
